...
void man(char * name)
{
    ...
    {
        printf("Description : Used to write data in regular file\n");
        printf("Usage : write File_name\n After this enter the data that we want write\n");
    }
...
void InitialiseSuperBlock()
{
    ...
    printf("Superblock initalise sucessfully..!\n");
}
...
int rm_File(char * name)
{
    ...
    if((UFDTArr[fd].ptrfiletable->ptrinode->LinkCount) == 0)
    {
        ...
        //strcmp(UFDTArr[fd].ptrfiletable->ptrinode->FileName,tmp);
...
int main()
{
    ...
    while(1) //shell
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminating the CUSTOMIZED FILE SYSTEM.....Thank You......\n");
                break;
            }
            else
            {
        ...
        {
            if(strcmp(command[0],"lseek") == 0)   //lseek demo.txt size 0/1/2
            {
                fd = GetFDFromName(command[1]);
